...
class SoapClient(object):
    ...
    def __init__(self, location = None, action = None, namespace = None,
        ...
        if namespace:
            self.namespace = namespace # if namespace, override the namespace set in the self.wsdl()
...
<%(soap_ns)s:Body %(body_xmlns)s>
    ...
    def __getattr__(self, attr):
        ...
        if not self.services: # not using WSDL?
            return lambda *args, **kwargs: myclass.call(attr,*args,**kwargs)
        else: # using WSDL:
            return lambda *args, **kwargs: myclass.wsdl_call(attr,*args,**kwargs)
